...
return [
    ...
    */
    ...
    |
    */
    'app_client_id' => env('AWS_COGNITO_CLIENT_ID', isset($_ENV['AWS_COGNITO_CLIENT_ID']) ? $_ENV['AWS_COGNITO_CLIENT_ID'] : ''),
    'app_client_secret' => env('AWS_COGNITO_CLIENT_SECRET', isset($_ENV['AWS_COGNITO_CLIENT_SECRET']) ? $_ENV['AWS_COGNITO_CLIENT_SECRET'] : ''),
    'user_pool_id' => env('AWS_COGNITO_USER_POOL_ID', isset($_ENV['AWS_COGNITO_USER_POOL_ID']) ? $_ENV['AWS_COGNITO_USER_POOL_ID'] : ''),
    'region' => env('AWS_COGNITO_REGION', isset($_ENV['AWS_COGNITO_REGION']) ? $_ENV['AWS_COGNITO_REGION'] : 'us-east-1'),
    'version' => env('AWS_COGNITO_VERSION', isset($_ENV['AWS_COGNITO_VERSION']) ? $_ENV['AWS_COGNITO_VERSION'] : 'latest'),
    ...
    |
    */
    'app_client_secret_allow' => env('AWS_COGNITO_CLIENT_SECRET_ALLOW', isset($_ENV['AWS_COGNITO_CLIENT_SECRET_ALLOW']) ? $_ENV['AWS_COGNITO_CLIENT_SECRET_ALLOW'] : true),
