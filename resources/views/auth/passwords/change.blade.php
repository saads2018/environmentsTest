        ...
        <div class="form-title">
            ...
            <form method="POST" action="{{ route('cognito.action.change.password') }}">
                ...
                <div class="form-input">
                    ...
                    <input id="email" type="hidden" class="@error('email') is-invalid @enderror" name="email" value="{{{ Auth::user()->email }}}" autocomplete="email" required />
                ...
                <div class="form-input">
                    <label for="password">{{ __('Existing Password') }}</label>
                ...
                <div class="form-input">
                    ...
                    <input id="new_password_confirmation" type="password" name="new_password_confirmation" required autocomplete="new_password_confirmation" />
                </div>

                <button type="submit" class="form-btn">{{ __('Save') }}</button>
            </form>
    </div>
