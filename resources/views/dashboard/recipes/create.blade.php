                    ...
                    <div class="">
                        ...
                        <div class="add-diet-inner">
                            <div class="add-wrapper-item">
                                ...
                                <input name="title" type="text" placeholder="e.g. Lemon chicken" value="{{ old('title') }}" class="@error('title') error @enderror" />
                                @error('title')
                                    <div class="error-message">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="add-wrapper-item">
                                ...
                                <input name="servings" type="text" placeholder="e.g. 6" value="{{ old('servings') }}" class="@error('servings') error @enderror" />
                                @error('servings')
                                    <div class="error-message">{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="add-wrapper-item">
                                ...
                                <div>
                                    <input name="cook_time" type="number" placeholder="e.g. 20" value="{{ old('cook_time') }}" class="@error('cook_time') error @enderror" />
                                    <span>min.</span>
                                    @error('cook_time')
                                        <div class="error-message">{{$message}}</div>
                                    @enderror
