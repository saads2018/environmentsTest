                                                        ...
                                                        <td align="center">
                                                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="content-card">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <p>Your appointment <br/> with <span>{{$appointment->physician->user->first_name}} {{$appointment->physician->user->last_name}}</span> on <span>{{ $appointment->start_time->format('F d') }}</span> at <span>{{ $appointment->start_time->setTimezone('America/Chicago')->format('h:i') }} - {{ $appointment->finish_time->setTimezone('America/Chicago')->format('h:i A') }}</span> has been <b><i>cancelled</i></b>.</p>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
