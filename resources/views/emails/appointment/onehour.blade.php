                                                        ...
                                                        <td align="center">
                                                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="content-card">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <p>Your appointment starts in <span>1 hour</span><br/>. At <span>{{ $appointment->start_time->setTimezone('America/Chicago')->format('h:i') }}</span> to <span>{{ $appointment->finish_time->setTimezone('America/Chicago')->format('h:i A') }}</span> with <span>{{$appointment->physician->user->first_name}} {{$appointment->physician->user->last_name}}</span>.</p>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
