                                                        ...
                                                        <td align="center">
                                                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="content-card">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <p>Don't forget about your appointment <br/><span>today</span> at <span>{{ $appointment->start_time->setTimezone('America/Chicago')->format('h:i') }} - {{ $appointment->finish_time->setTimezone('America/Chicago')->format('h:i A') }}</span> with <span>{{$appointment->physician->user->first_name}} {{$appointment->physician->user->last_name}}</span>.</p>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
