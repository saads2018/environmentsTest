                                                        ...
                                                        <td align="center">
                                                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="content-card">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <p>You've got a new message from <span>{{$msg->patient->user->first_name}} {{$msg->patient->user->last_name}}</span>.</p>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="padding-bottom: 0;" align="center">
                                                            <a href="https://{{tenant('id')}}.naviwellgroup.com/messages" target="_blank">Go to Messages</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
