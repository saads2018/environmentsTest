                                                        ...
                                                        <td align="center">
                                                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="content-card">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <p><span>{{$quiz->patient->user->first_name}} {{$quiz->patient->user->last_name}}</span> has completed quarterly questionnaire.</p>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="padding-bottom: 0;" align="center">
                                                            <a href="https://{{tenant('id')}}.naviwellgroup.com/patients/{{$quiz->patient->id}}" target="_blank">View Questionnaire results</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
