                                                        ...
                                                        <td align="center">
                                                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="content-card">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <p>Hello, {{$patient->user->first_name}} {{$patient->user->last_name}}.</p>
                                                                            <p>Our physican has assigned you a quarterly questionnaire. Please have this completed before your appointment on {{tenant("name")}}.</p>
