                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <p>Our records show that you have not yet completed quiz <span>"{{$quiz->title}}"</span>. Please have this completed before your appointment at {{tenant("name")}}.</p>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="padding-bottom: 0;" align="center">
                                                            <a href="#" target="_blank">Go to Quizzes</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
